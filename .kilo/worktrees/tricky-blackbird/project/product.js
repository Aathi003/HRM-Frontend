document.addEventListener("DOMContentLoaded", () => {
    ...
    const treadmillBtn = document.getElementById("treadmillBtn");
    const sbikeBtn = document.getElementById("sbikeBtn");
    const gymStationBtn = document.getElementById("gymStationBtn");

    // Navigation buttons - Mobile
    const homeBtnMobile = document.getElementById("homeBtnMobile");
    const allBtnMobile = document.getElementById("allBtnMobile");
    const treadmillBtnMobile = document.getElementById("treadmillBtnMobile");
    const sbikeBtnMobile = document.getElementById("sbikeBtnMobile");
    const gymStationBtnMobile = document.getElementById("gymStationBtnMobile");

    // Product sections
    const treadmillSection = document.getElementById("treadmill-section");
    const sbikeSection = document.getElementById("sbike-section");
    const gymStationSection = document.getElementById("gym-station-section");
    ...
    function showAllSections() {
        treadmillSection.classList.remove("hidden");
        sbikeSection.classList.remove("hidden");
        gymStationSection.classList.remove("hidden");
        ...
        if (allBtnMobile) allBtnMobile.classList.add('active');
    }

    function showSection(section, desktopBtn, mobileBtn) {
        // Hide all sections
        treadmillSection.classList.add("hidden");
        sbikeSection.classList.add("hidden");
        gymStationSection.classList.add("hidden");
    ...
    function setupEventListeners() {
        ...
        if (treadmillBtn) {
            treadmillBtn.addEventListener("click", (e) => {
                e.preventDefault();
                showSection(treadmillSection, treadmillBtn, treadmillBtnMobile);
            });
        }

        if (sbikeBtn) {
            sbikeBtn.addEventListener("click", (e) => {
                e.preventDefault();
                showSection(sbikeSection, sbikeBtn, sbikeBtnMobile);
            });
        }

        if (gymStationBtn) {
            gymStationBtn.addEventListener("click", (e) => {
                e.preventDefault();
                showSection(gymStationSection, gymStationBtn, gymStationBtnMobile);
            });
        }
        ...
        if (allBtnMobile) {
            allBtnMobile.addEventListener("click", (e) => {
                e.preventDefault();
                showAllSections();
            });
        }

        if (treadmillBtnMobile) {
            treadmillBtnMobile.addEventListener("click", (e) => {
                e.preventDefault();
                showSection(treadmillSection, treadmillBtn, treadmillBtnMobile);
            });
        }
        ...
        if (sbikeBtnMobile) {
            sbikeBtnMobile.addEventListener("click", (e) => {
                e.preventDefault();
                showSection(sbikeSection, sbikeBtn, sbikeBtnMobile);
            });
        }

        if (gymStationBtnMobile) {
            gymStationBtnMobile.addEventListener("click", (e) => {
                e.preventDefault();
                showSection(gymStationSection, gymStationBtn, gymStationBtnMobile);
            });
        }
    ...
    initializeFromStorage();
    setupEventListeners();
    showAllSections(); // Initialize with all sections shown
